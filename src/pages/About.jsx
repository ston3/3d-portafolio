  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        Hello, I'm <span className="blue-gradient_text font-semibold drop-shadow">Rainer</span>
      </h1>
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>Software Engineer based in La Paz - Bolivia, specializing in technical education through hands-on learning and building application.</p>
      </div>
            ...
            >
              ...
              <ul className='my-5 list-disc ml-5 space-y-2'>
                {experience.points.map((point, index) => (
                  <li key={index + point} className='text-black-500/50 font-normal pl-1 text-sm'>
                    {point}
                  </li>
                ))}
              </ul>
